          ...
          {session ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 py-1 px-1 pr-3 rounded-full bg-muted hover:bg-muted/80 transition-colors"
              >
              ...
              {isProfileOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2 w-52 rounded-md bg-card shadow-xl z-50 py-1 border border-border">
                    <Link
                      href="/profile"
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-3 text-sm hover:bg-muted transition-colors w-full text-left"
                    >
            ...
            <div className="flex items-center gap-4">
              <Link href="/register">
                <span className="text-muted-foreground hover:text-foreground font-bold text-sm transition-colors">
                  Sign up
                </span>
              </Link>
              <Link href="/login">
